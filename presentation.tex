...
{\small\bfseries\color{Cmuted}与普通 RAG demo 的本质区别}\\[0.08cm]
\begin{tcolorbox}[enhanced, boxrule=0pt, colback=white, colframe=white, left=0pt, right=0pt, top=0pt, bottom=0pt]
{\footnotesize
\begin{tabularx}{\textwidth}{>{\bfseries}p{0.12\textwidth} >{\raggedright\arraybackslash}p{0.28\textwidth} >{\raggedright\arraybackslash}p{0.28\textwidth} >{\raggedright\arraybackslash}X}
\toprule
