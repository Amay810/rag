...
\setbeamercolor{takeawaybox}{fg=white,bg=Ctakebg}
...
\newcommand{\takeaway}[1]{%
  \par\vfill
  \noindent\begin{beamercolorbox}[wd=\paperwidth,ht=2.8ex,dp=1.2ex,leftskip=0.8cm,rightskip=0.35cm]{takeawaybox}%
    {\scriptsize\textbf{Takeaway}\enspace#1}%
  \end{beamercolorbox}%
}
