...
\setbeamertemplate{frametitle}{%
  \vspace*{0.18cm}%
  \hspace*{0.8cm}%
  \begin{beamercolorbox}[wd=\dimexpr\paperwidth-1.2cm\relax,leftskip=0pt,rightskip=0pt]{frametitle}%
  ...
  \end{beamercolorbox}%
  \vspace{0.06cm}%
  {\color{Cblue!20}\hspace*{0.8cm}\rule{\dimexpr\paperwidth-1.2cm\relax}{0.5pt}}%
  \vspace{0.08cm}%
}
...
\newcommand{\takeaway}[1]{%
  ...
  \begin{tcolorbox}[
    ...
    width=\dimexpr\textwidth-0.15cm\relax, nobeforeafter
  ]%
